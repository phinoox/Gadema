...
1. **No "wrong" starting point** — If a player thinks in systems, they can create sequences first. If a writer thinks in images, they can write scenes first. Both are valid.
